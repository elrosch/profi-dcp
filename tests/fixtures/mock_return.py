import binascii
import random
import profi_dcp.protocol
import profi_dcp.util
import profi_dcp.dcp_constants
...
class MockReturn:
    ...
    frame_id = None
    service_id = None
    service_type = profi_dcp.dcp_constants.ServiceType.RESPONSE
    ...
    def generate_identify(self):
        ...
        self.service_id = profi_dcp.dcp_constants.ServiceID.IDENTIFY
    ...
    def generate_get(self, param):
        ...
        self.service_id = profi_dcp.dcp_constants.ServiceID.GET
        ...
        self.block = profi_dcp.protocol.DCPBlockRequest(opt, subopt, len(
    ...
    def generate_set(self):
        ...
        """
        self.frame_id = 0xfefd
        self.service_id = profi_dcp.dcp_constants.ServiceID.SET
        block_content = bytes(
            [0x02, 0x02]) + binascii.unhexlify(self.devices[self.dst_custom].err_code)
        self.block = profi_dcp.protocol.DCPBlockRequest(
